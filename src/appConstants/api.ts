...
const MAPBOX_STYLE_ID = 'ckm9i6orqfd8f17ry0otm884h';
export const MAPBOX_TILES_STRING = `https://api.mapbox.com/styles/v1/liza42023/${MAPBOX_STYLE_ID}/tiles/%z/%x/%y@2x?access_token=${MAPBOX_API_KEY}`;
