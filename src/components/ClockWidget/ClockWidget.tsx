...
export const ClockWidget: FC<TClockWidgetProps> = ({data, theme}) => {
  ...
  const tick = () => {
    const dateLocaleCityNow = moment().locale(i18n.language).tz(localeCity.timezone);
    const dateOtherCityNow = moment().locale(i18n.language).tz(otherCity.timezone);
    ...
    <div className={classes.wrapper}>
      <div className={classes.wrapperClock}>
        ...
        <div className={classes.timeBlock}>
          <h4 className={theme === 'light' ? classes.lightTheme : classes.darkTheme}>{localeCity.name}</h4>
        ...
        <div className={classes.timeBlock}>
          <h4 className={theme === 'light' ? classes.lightTheme : classes.darkTheme}>{otherCity.name}</h4>
