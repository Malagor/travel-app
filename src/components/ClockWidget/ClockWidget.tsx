...
const getTimeForForDate = (date: moment.Moment) => date.format('dddd, ll')
    ...
    <div className={classes.wrapper}>
      <div className={classes.wrapperClock}>
        ...
        <div className={classes.timeBlock}>
          ...
          <div className={classes.timeBlock__time}>
            <DateString day={getTimeForForDate(localeDate)} theme={theme}/>
          </div>
        </div>
        ...
        <div className={classes.timeBlock}>
          ...
          <div className={classes.timeBlock__time}>
            <DateString day={getTimeForForDate(otherDate)} theme={theme}/>
          </div>
        </div>
